...
User.where(uid: "bishop").first_or_create!(name: "Bishop", role: Synthetic.create!(personality: "Calm and methodical"))
User.where(uid: "ash").first_or_create!(name: "Ash", role: Synthetic.create!(personality: "Direct and efficient"))
User.where(uid: "call").first_or_create!(name: "Call", role: Synthetic.create!(personality: "Curious and empathetic"))
