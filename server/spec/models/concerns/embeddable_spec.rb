...
RSpec.describe Embeddable, type: :model do
  ...
  describe "after_save callback" do
    it "enqueues GenerateEmbeddingJob when content changes" do
      memory = Synthetic::Memory.create!(synthetic: bishop, content: "Initial fact", tags: ["test"])
    ...
    it "does not enqueue when non-content fields change" do
      memory = Synthetic::Memory.create!(synthetic: bishop, content: "A fact", tags: ["test"])
